    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('modified', model_utils.fields.AutoLastModifiedField(default=django.utils.timezone.now, editable=False, verbose_name='modified')),
                ('is_removed', models.BooleanField(default=False)),
                ('transaction_type', model_utils.fields.StatusField(choices=[('buy', 'Buy'), ('sell', 'Sell')], default='buy', max_length=100, no_check_for_status=True)),
                ...
                ('item', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='transactions', to='portfolios.PortfolioItem')),
            ],
            options={
                'abstract': False,
            },
